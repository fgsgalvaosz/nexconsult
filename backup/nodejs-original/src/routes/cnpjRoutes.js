...
/**
 * @swagger
 * /api/cnpj/concurrent/stats:
 *   get:
 *     summary: Obter estatísticas do sistema concorrente
 *     tags: [Concurrent System]
 *     responses:
 *       200:
 *         description: Estatísticas detalhadas do sistema concorrente
 *       503:
 *         description: Sistema concorrente não disponível
 */
router.get('/concurrent/stats', cnpjController.getConcurrentStats);

/**
 * @swagger
 * /api/cnpj/concurrent/health:
 *   get:
 ...
 */
router.get('/concurrent/health', cnpjController.getSystemHealth);

/**
 * @swagger
 * /api/cnpj/concurrent/dashboard:
 *   get:
 *     summary: Obter dados do dashboard em tempo real
 *     tags: [Concurrent System]
 *     responses:
 *       200:
 *         description: Dados do dashboard em tempo real
 *       503:
 *         description: Dashboard não disponível
 */
router.get('/concurrent/dashboard', cnpjController.getDashboard);
